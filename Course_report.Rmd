...
radarchart(
  df3,
  pfcol = c(rgb(0.51, 0.167, 0.236, 0.25),NA),
  pcol= c(NA,"#3e9cbf"), plty = 1, plwd = 3,
  axistype = 4,
  title = "Institutional profile", caxislabels = c(0,10, 20, 30, 40),
  axislabcol = "black"
) 
legend(
  x = -2.5,y=0.3, legend = c("Nat. Average","Institution"), horiz = F,
  bty = "n", pch = 20 , col = c(rgb(0.51, 0.167, 0.236, 0.25), "Blue"),
  text.col = "black", cex = 1, pt.cex = 1.5)
